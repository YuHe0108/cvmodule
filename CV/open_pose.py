...
def detect_key_point(model_path, image_path, out_dir=None, inWidth=368, inHeight=368, threshhold=0.2):
    ...
    for pair in POSE_PAIRS:
        ...
        if points[idFrom] and points[idTo]:
            cv.line(frame, points[idFrom], points[idTo], (0, 255, 0), 3)  # 绘制连接线
            # 绘制预测的人体关键点的起点和终点
...
if __name__ == "__main__":
    model_path_ = "pb/graph_opt.pb"
    # image_path = "body/*.jpg"
    out_dir_ = None
    # detect_image_list_key_point(image_path,out_dir)
    image_path_ = r"E:\tookit_backup\Documents\Opencv\images\human.jpg"
    detect_key_point(model_path_, image_path_, out_dir_, inWidth=368, inHeight=368, threshhold=0.05)
